...
//for attibuted text like "followers" string use NSMutable String
...
class UserProfileHeader: UICollectionViewCell {
    ...
    let editProfileButton: UIButton = {
        ...
        //we need cgCOlor for border propoerties
...
//        backgroundColor = .blue
        ...
        setupBottomToolbar()
        //order is important for anchoring
    ...
    fileprivate func setupBottomToolbar(){
        //for lines on the up and downside of the button
